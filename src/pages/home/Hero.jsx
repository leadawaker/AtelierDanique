...
// wash on compact screens.
function veilStyle(compact) {
  if (compact) return 'position:absolute;inset:0;background:rgba(252,250,246,' + HERO_VEIL.mobileOpacity / 100 + ')';
...
function HeroText({ t, compact, links }) {
  ...
  if (!split) {
    return (
      <section style={s('position:relative;background:#F1EFE8;overflow:hidden')}>
        ...
        <div style={s(veilStyle(compact))}></div>
