...
const META = {
  en: {
    ...
    commission: ['Commission a painting · Atelier Danique', 'Send your photo and tell the story behind it. A5, A4 or A3 watercolour, ready in 5 working days, half paid up front.'],
  ...
  nl: {
    ...
    commission: ['Schilderij laten maken · Atelier Danique', 'Stuur je foto en vertel het verhaal erachter. Aquarel op A5, A4 of A3, klaar in 5 werkdagen, de helft vooraf.'],
  ...
  pt: {
    ...
    commission: ['Encomende uma pintura · Atelier Danique', 'Envie sua foto e conte a história por trás dela. Aquarela em A5, A4 ou A3, pronta em 5 dias úteis, metade adiantada.'],
