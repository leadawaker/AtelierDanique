...
export function jsonLd(lang, page, content) {
  ...
  const graph = [
    { '@type': 'WebSite', '@id': id('website'), url: SITE + '/', name: 'Atelier Danique', inLanguage: ['nl', 'en', 'pt-BR'], publisher: { '@id': id('business') } },
    {
      ...
      priceRange: '€' + Math.min(p.a5.eur, p.a4.eur) + '-€' + Math.max(p.a5.eur, p.a4.eur),
      makesOffer: [...offer('A5 watercolour painting', p.a5.eur, p.a5.brl), ...offer('A4 watercolour painting', p.a4.eur, p.a4.brl)],
    },
