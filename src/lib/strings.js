...
export const STRINGS = {
  en: {
    ...
    priceTitle: 'Pricing per size', sizeLabelA5: 'SIZE A5 -', sizeLabelA4: 'SIZE A4 -', included: "What's included", priceUntil: 'Introductory price until',
  ...
  pt: {
    ...
    priceTitle: 'Preço por tamanho', sizeLabelA5: 'TAMANHO A5 -', sizeLabelA4: 'TAMANHO A4 -', included: 'O que está incluído', priceUntil: 'Preço de lançamento até',
  ...
  nl: {
    ...
    priceTitle: 'Prijs per formaat', sizeLabelA5: 'FORMAAT A5 -', sizeLabelA4: 'FORMAAT A4 -', included: 'Wat is inbegrepen', priceUntil: 'Introductieprijs tot',
