...
export const STRINGS = {
  en: {
    ...
    procEyebrow: 'The process', procTitle: 'From a moment to something you can keep.', procIntro: 'A simple four-step process, from choosing your photo to receiving your artwork.',
    ...
    procCloseA: 'No complicated process. No design decisions to make.', procCloseB: "You choose the moment. I'll take care of the rest.",
    ...
    inc7: 'Tracked shipping: €5 NL, €10 Europe + UK, €15 rest of the world', inc10: "Free pick-up in 's-Hertogenbosch", inc8: 'Your photos stay private, never shared without asking', inc9: '30 days guarantee',
  ...
  pt: {
    ...
    procEyebrow: 'O processo', procTitle: 'De um momento a algo para guardar.', procIntro: 'Um processo simples em quatro passos, da escolha da foto até receber sua obra.',
    ...
    procCloseA: 'Sem processo complicado. Sem decisões de design para tomar.', procCloseB: "Você escolhe o momento. Eu cuido do resto.",
    ...
    inc7: 'Frete rastreado: €5 Holanda, €10 Europa + Reino Unido, €15 resto do mundo', inc10: "Retirada grátis em 's-Hertogenbosch", inc8: 'Suas fotos ficam privadas, nunca compartilhadas sem permissão', inc9: 'Garantia de 30 dias',
  ...
  nl: {
    ...
    procEyebrow: 'Het proces', procTitle: 'Van een moment naar iets om te bewaren.', procIntro: 'Een eenvoudig proces in vier stappen, van het kiezen van je foto tot het ontvangen van je kunstwerk.',
    ...
    procCloseA: 'Geen ingewikkeld proces. Geen ontwerpkeuzes om te maken.', procCloseB: "Jij kiest het moment. Ik zorg voor de rest.",
    ...
    inc7: 'Verzending met track & trace: €5 NL, €10 Europa + VK, €15 rest van de wereld', inc10: "Gratis ophalen in 's-Hertogenbosch", inc8: "Je foto's blijven privé, nooit gedeeld zonder te vragen", inc9: '30 dagen garantie',
