...
export const STRINGS = {
  en: {
    ...
    launchNote: "I'm opening my first {total} commission spots at this launch price.\nLaunch pricing · {left} of {total} spots remaining",
  ...
  pt: {
    ...
    launchNote: 'Estou abrindo minhas primeiras {total} vagas de encomenda com este preço de lançamento.\nPreços de lançamento · {left} de {total} vagas restantes',
  ...
  nl: {
    ...
    launchNote: 'Ik open mijn eerste {total} plekken voor opdrachten tegen deze introductieprijs.\nIntroductieprijzen · nog {left} van {total} plekken',
