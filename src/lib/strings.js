...
export const STRINGS = {
  en: {
    ...
    launchIntro: "I'm opening my first {total} commission spots at this launch price.", launchLeft: '{n} spots still available, after that prices will increase.', launchLeftOne: '1 spot still available, after that prices will increase.',
  ...
  pt: {
    ...
    launchIntro: 'Estou abrindo minhas primeiras {total} vagas de encomenda com este preço de lançamento.', launchLeft: '{n} vagas ainda disponíveis, depois disso os preços vão aumentar.', launchLeftOne: '1 vaga ainda disponível, depois disso os preços vão aumentar.',
  ...
  nl: {
    ...
    launchIntro: 'Ik open mijn eerste {total} plekken voor opdrachten tegen deze introductieprijs.', launchLeft: 'Nog {n} plekken beschikbaar, daarna gaan de prijzen omhoog.', launchLeftOne: 'Nog 1 plek beschikbaar, daarna gaan de prijzen omhoog.',
